...
- docs: README/README.ja/ARCHITECTURE/CLAUDE describe the symlink containment rule for `static/`, the fixed-URL assets fingerprinting leaves alone, and the dependency ordering that makes CSS-to-CSS references resolve
